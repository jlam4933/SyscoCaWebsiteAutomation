...
public class Website_Sysco_ca_201_300 {
    ...
    public void testLoadTheWebsiteUrlsAndtakingscreenshotOfFullpage() throws URISyntaxException {
        ...
        for (int rownum = 201; rownum <= 300; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/SyscoCanadaWebsite_Screenshots_201_300");
