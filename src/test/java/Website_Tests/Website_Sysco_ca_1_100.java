...
public class Website_Sysco_ca_1_100 {
    ...
    public void testLoadTheWebsiteUrlsAndtakingscreenshotOfFullpage() throws URISyntaxException {
        ...
        for (int rownum = 2; rownum <= 100; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/SyscoCanadaWebsite_Screenshots_1_100");
