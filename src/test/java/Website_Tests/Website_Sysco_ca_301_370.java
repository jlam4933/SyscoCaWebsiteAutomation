...
public class Website_Sysco_ca_301_370 {
    ...
    public void testLoadTheWebsiteUrlsAndtakingscreenshotOfFullpage() throws URISyntaxException {
        ...
        for (int rownum = 301; rownum <= rowCount; rownum++) {
            ...
            Shutterbug.shootPage(driver, Capture.FULL, 500, true).withName(rownum + shorturl).save("src/main/resources/SyscoCanadaWebsite_Screenshots_301_370");
